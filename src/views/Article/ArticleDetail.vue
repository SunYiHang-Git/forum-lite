...
import { getArticleInfoById, getReplyListAPI } from '@/api/home'
...
const getReplyData = async () => {
  const params = { PostsID: ArticleId.value, PageNum: '0', PageSize: '20', iSort: 1 }
  const { firstList, secondList } = await getReplyListAPI(params)
  firstList.forEach((item: any) => {
    item.children = secondList.filter((v) => v.pid === item.id)
  })
    ...
    <div class="detail-box">
      <div class="left">
        <div class="collect-box">
          <k-badge :value="122" type="info" class="item dfc">
            <IconStar :size="26" />
          </k-badge>
        </div>
        <div class="reply-box">
          <k-badge :value="22" type="info" class="item dfc">
      ...
      <div class="content">
        ...
        <div class="comment-box">
          <div class="reply-num-box">3 条回复</div>
